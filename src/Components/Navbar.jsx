...
<div className="  lg:justify-center flex md:justify-between  p-3 items-center ">
...
<ul className='flex text-[14px]  space-x-7  float-right  mr-5  cursor-pointer'>
  <li className='hover:text-blue-700 hover:underline duration-300' >Academic & Government</li>
  <li className='hover:text-blue-700 hover:underline duration-300'>Health</li>
  <li className='hover:text-blue-700 hover:underline duration-300'>Industry</li>
  <li className='hover:text-blue-700 hover:underline duration-300'>About</li>
  <li className='hover:text-blue-700 hover:underline duration-300'>Contact Us</li>
